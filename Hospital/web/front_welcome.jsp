<%-- 
    Document   : front_welcome
    Created on : Apr 19, 2015, 5:43:57 PM
    Author     : Sahil
--%>
...
<div id="left">
			<h1>Welcome Dear Frontier</h1><br />
			<h2>Patient Section</h2><br>
			<p>-->&nbsp;You can check the Details of Patients by clicking the view details in the Patient details menu.<br>
						-->&nbsp;You can view their the full Details of Patients by clicking the view details in the Employee details menu.<br>
			-->&nbsp;You can know the history & Medicine of patients in this section.<br>
			<p>-->&nbsp;You can check the Details of Patients by clicking the view details in the Patient details menu.<br>
						-->&nbsp;You can view their the full Details of Patients by clicking the view details in the Employee details menu.<br>
			-->&nbsp;You can know the history & Medicine of patients in this section.<br>
